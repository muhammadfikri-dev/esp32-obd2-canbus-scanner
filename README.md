...
| 2 | **Transceiver CAN-Bus SN65HVD230 / MCP2551** | 1 Unit | Penerjemah sinyal diferensial CAN_H & CAN_L level 3.3V/5V |
| 3 | **Kabel DB9 / OBD-II Male to Open Wire** | 1 Unit | Konektor standar antarmuka diagnostik kendaraan |
| 4 | **Layar OLED 0.96 Inch I2C SSD1306 (128x64)** | 1 Unit | Menampilkan data telemetri, menu, dan status sistem secara visual |
...
| 11 | **5V DC via USB-C / MicroUSB atau 7-12V DC via Vin (Disarankan PSU 5V 2A)** | 1 Unit | Sumber daya listrik stabil untuk seluruh rangkaian |
