/**
 * =========================================================================================
 * Project     : ESP32 OBD-II CAN-Bus Real-Time ECU Diagnostic Scanner & HUD
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Automotive diagnostic scanner interfacing ISO 15765-4 CAN protocol, requesting live PIDs (RPM, Speed, MAP, Coolant), and projecting metrics on OLED HUD.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-obd2-canbus-scanner";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 OBD-II CAN-Bus Real-Time ECU Diagnostic Scanner & HUD"));
